...
Scroller.prototype = {
    ...
    */
    ...
    scrollTo : function (left, top, isAnimated, zoom) {
        ...
        // Publish new values
        if (!this.__isTracking) { // allow user to re-grab and stop
    ...
    */
    ...
    __publish : function (left, top, zoom, isAnimated) {
        ...
        if (isAnimated && this.options.animating) {
            ...
            this.__isAnimating = animate.start(step, verify, completed, this.options.animationDuration,
                wasAnimating ?
                  easingFunctions[this.options.easing].out :
                  easingFunctions[this.options.easing].inOut
            );
    ...
    */
    ...
    __stepThroughDeceleration : function (render) {
        ...
        if (!this.options.paging) {
            ...
            this.__decelerationVelocityX *= this.options.frictionFactor;
            this.__decelerationVelocityY *= this.options.frictionFactor;
        }
